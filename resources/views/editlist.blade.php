							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="card card-primary">
										...
										<form  method="post" action="javascript:void(0)"  enctype="multipart/form-data" id="editlist">
											...
											<div class="form-group">
												...
												<textarea name="description" placeholder="Enter Description" id="description" class="form-control">{{@$edit->description}}</textarea>
											</div>
...
<script type="text/javascript">
 //function validatessForm(){
 	$('#editlist').on('submit',(function(e) {
 		...
 		$('.description_error').html(description_err);
 		if (name_err || email_err || description_err) {
 			return false;
 		}else{
 			true;
